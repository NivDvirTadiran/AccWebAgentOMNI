...
n._linkedSeries.legendMarkerType:K.getDefaultLegendMarker(n._linkedSeries.type):K.getDefaultLegendMarker(n.type):n.markerType,g=n.legendText?n.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:n,dataPoint:null}):n.name,v=n.legendMarkerColor=n.legendMarkerColor?n.legendMarkerColor:n.markerColor?n.markerColor:"error"===n.type?r(n.whiskerColor)?n._colorSet[0]:n.whiskerColor:n._colorSet[0],t=n.markerSize||"line"!==n.type&&"stepLine"!==n.type&&"spline"!==
n.type?0.75*this.lineHeight:0,w=n.legendMarkerBorderColor?n.legendMarkerBorderColor:n.markerBorderColor,s=n.legendMarkerBorderThickness?n.legendMarkerBorderThickness:n.markerBorderThickness?Math.max(1,Math.round(0.2*t)):0;"error"===n.type&&this.errorMarkerColor.push(v);g=this.chart.replaceKeywordsWithValue(g,n.dataPoints[0],n,p);q={markerType:q,markerColor:v,text:g,textBlock:null,chartType:n.type,markerSize:t,lineColor:n._colorSet[0],dataSeriesIndex:n.index,dataPointIndex:null,markerBorderColor:w,
markerBorderThickness:s};m.push(q)}else for(var x=0;x<n.dataPoints.length;x++){var y=n.dataPoints[x],q=y.legendMarkerType?y.legendMarkerType:n.legendMarkerType?n.legendMarkerType:K.getDefaultLegendMarker(n.type),g=y.legendText?y.legendText:n.legendText?n.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:n,dataPoint:y}):y.name?y.name:"DataPoint: "+(x+1),v=y.legendMarkerColor?y.legendMarkerColor:n.legendMarkerColor?n.legendMarkerColor:y.color?
y.color:n.color?n.color:n._colorSet[x%n._colorSet.length],t=0.75*this.lineHeight,w=y.legendMarkerBorderColor?y.legendMarkerBorderColor:n.legendMarkerBorderColor?n.legendMarkerBorderColor:y.markerBorderColor?y.markerBorderColor:n.markerBorderColor,s=y.legendMarkerBorderThickness?y.legendMarkerBorderThickness:n.legendMarkerBorderThickness?n.legendMarkerBorderThickness:y.markerBorderThickness||n.markerBorderThickness?Math.max(1,Math.round(0.2*t)):0,g=this.chart.replaceKeywordsWithValue(g,y,n,x),q={markerType:q,
markerColor:v,text:g,textBlock:null,chartType:n.type,markerSize:t,dataSeriesIndex:p,dataPointIndex:x,markerBorderColor:w,markerBorderThickness:s};(y.showInLegend||n.showInLegend&&!1!==y.showInLegend)&&m.push(q)}}!0===this.reversed&&m.reverse();if(0<m.length){n=null;v=g=y=x=0;y=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=f;t=0===t?0.75*
...
textBaseline:"middle"});q.textBlock.measureText();null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(t+k+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0)));if(!n||n.width+Math.round(q.textBlock.width+t+k+(0===n.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))>f)n={items:[],width:0},h.push(n),this.height+=g,g=0;g=Math.max(g,q.textBlock.height)}else q.textBlock=new ia(this.ctx,
{x:0,y:0,maxWidth:y,maxHeight:!0===this.itemWrap?l:1.5*this.fontSize,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"}),q.textBlock.measureText(),null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(t+k+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))),this.height<l-this.lineHeight?(n={items:[],width:0},
h.push(n)):(n=h[x],x=(x+1)%h.length),this.height+=q.textBlock.height;q.textBlock.x=n.width;q.textBlock.y=0;n.width+=Math.round(q.textBlock.width+t+k+(0===n.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0));n.items.push(q);this.width=Math.max(n.width,this.width);v=q.textBlock.width+(t+k+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))}}this.itemWidth=v;this.height=!1===this.itemWrap?
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();y.version="v3.2.6 GA";window.CanvasJS&&(y&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=y)})();
