import {  ElementRef,ViewChild, AfterContentInit,Component, Inject, LOCALE_ID, OnDestroy, OnInit } from '@angular/core';
...
export class KeybComponent implements OnInit, OnDestroy,AfterContentInit {
