...
import { AccButtons, AccOneButton2, accbutton, accButtonInIni, TelActionIni } from './AccBtnsDef';
...
export class AccAgentService implements OnInit, OnDestroy {
   ...
   // ---------
    ...
    public answerIdx = 0;
    public busyIdx = 1;
    public ACC_VERSION: string = '8.5.002';
    ...
    constructor(private router: Router, public coreApiService: CoreApiService,
        ...
        if (this.crmmode == null) {this.crmmode = "";}
            ...
            this.isSalesforce = true;
             //https://172.28.1.177:8445/accAgent/?crmmode=salesforce&mode=Lightning&isdtp=vw&sfdcIframeOrigin=https:%2F%2Fna85.lightning.force.com&nonce=e095448ebf3f4299846cddc1cdf2f1e5499fd59ac4c2ee38c4f6f8ac677ddc8e&ltn_app_id=06m1U000001Vtu7QAC&clc=0
 ...
 //               this.PrepareAndPutNotification(action, action + ",000," + this.agent.m_AgentNo + ", ," + this.agent.m_Extension + "," + relstr);
   ...
   SetCallType(actionCode:string){
    ...
    {
        //milseconds
        //var a = btoa(Date.now().toString());
        var a = Date.now().toString();
        var parts = a.split("").reverse();
  ...
  // ================================[ CheckUrl ] ==============================
   ...
   agentPreLogin(fromReloadOrTabClosed: boolean) {
    ...
    private handleError<T>(operation = 'operation', result?: T) {
       ...
       public HandleNotifications(notificationList: AccNotifications[])// string agentNo,int checkInterval,int checkCount, AgentStatus CheckedAgentStatus, AgentStatus CheckedCallStatus, out Agent A,out string err)
       {
           for (let i = 0; i < notificationList.length; i++) {
               try {
                   var n1 = notificationList[i].params;
                   var sessionid = notificationList[i].sessionid;
                   ...
                   switch (action) {
                       //
                       case "__SSOStatus":
                           this.log("__SSOStatus" + notificationList[i].agentNo + " " + notificationList[i].params);
                           break;
                       //
                       ...
                       case "updateagentmode":
                           {
                               ...
                               switch (response[3]) {
                                   ...
                                   case "rsrv":
                                       ...
                                       this.HandleCRMEvent("OnReserved", EmptyRsponse);
                       ...
                       case "signin":
                           this.SetLoginStatus(true);
                           //this.displayOnLogonImage();

                           break;
                       case "signout":
                           this.SetLoginStatus(false);
                           this.agent.m_AgentStatus = AgentStatus.Logout;
                           //this.displayOffLogonImage();
                       ...
                       case "__etasini":
                           try {
                               ...
                               if (this.accagentPage != null) {
                                ...
                                this.router.navigateByUrl('/AccAgentPage' + this.savedURLSearch);
      ...
      // ============================[getAllLists]==========================================
       ...
       setMainStatus(toStatus, ts, moretext) {
           ...
           //this.log("setMainStatus <" + toStatus + "-" + ts + ">");
           this.accagentPage.updateTimer(ts)
    ...
    SavePhonebook() {
        ...
        phonebookStr = JSON.stringify(this.phonebook, null, 4);
