/**
* @preserve CanvasJS HTML5 & JavaScript Charts - v3.2.6 GA - https://canvasjs.com/ 
...
function addExportMenu(chart) {
	...
	if (chart._menuButton) {
		...
		addEvent(chart._menuButton, "mouseover", function () {
			if (!preventMouseEvent) {
				setCSSProperties(chart._menuButton, { backgroundColor: chart.toolbar.backgroundColorOnHover, color: chart.toolbar.fontColorOnHover })
		...
		addEvent(chart._menuButton, "mouseout", function () {
			if (!preventMouseEvent) {
				setCSSProperties(chart._menuButton, { backgroundColor: chart.toolbar.backgroundColor, color: chart.toolbar.fontColor })
				if (navigator.userAgent.search("MSIE") <= 0)
	...
	if (!chart._dropdownMenu && chart.exportEnabled && isCanvasSupported) {
		var preventMouseEvent = false;
		...
		exportOption.style.backgroundColor = chart.toolbar.backgroundColor;
		...
		addEvent(exportOption, "mouseover", function () {
			if (!preventMouseEvent) {
				this.style.backgroundColor = chart.toolbar.backgroundColorOnHover;
		...
		addEvent(exportOption, "mouseout", function () {
			if (!preventMouseEvent) {
				this.style.backgroundColor = chart.toolbar.backgroundColor;
...
var CanvasJSChart = CanvasJS.Chart = (function () {
		...
		for (var i = 0; i < this._indexLabels.length; i++) {
			...
			if (this.plotInfo.axisPlacement === "normal") {
				...
				if (placement !== "inside") {	//outside or auto
					...
					if (direction > 0) {
						y = indexLabel.point.y - visibleHeight / 2 - marginY - offset;
	...
	Crosshair.prototype.showAt = function (value) {
		...
		for (var i = 0; i < chart.axisY2.length; i++) {
			...
			if (chart.axisY2[i].crosshair && chart.axisY2[i].crosshair.enabled && !isNullOrUndefined(crosshairValue) && chart._crosshairY2Value >= chart.axisY2[i].viewportMinimum && chart._crosshairY2Value <= chart.axisY2[i].viewportMaximum) {
			...
			if (this.chart.plotInfo.axisPlacement === "xySwapped") {
				...
				if (this.parent._position === "bottom" || this.parent._position === "top") {
					...
					if (this.parent.dataSeries[index].type === "rangeBar" || this.parent.dataSeries[index].type === "error") {
						...
						textBlock.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: label ? label : closest.dataPoint.y[dpsIndex] }) : !isNullOrUndefined(this.options.label) ? this.label : numberFormat(label ? label : closest.dataPoint.y[dpsIndex], this.valueFormatString, this.chart._cultureInfo);
					}
						...
						textBlock.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: label ? label : yPercent }) : !isNullOrUndefined(this.options.label) ? this.label : numberFormat(label ? label : yPercent, this.valueFormatString, this.chart._cultureInfo);
					}
					else {
					...
					if (hasAllLabels) {
						...
						textBlock.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: label ? label : closest.dataPoint.x }) : !isNullOrUndefined(this.options.label) ? this.label : dateFormat(label ? label : closest.dataPoint.x, this.valueFormatString, this.chart._cultureInfo);
					}
					else if (this.parent.valueType === "number") {
						textBlock.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: label ? label : closest.dataPoint.x }) : !isNullOrUndefined(this.options.label) ? this.label : numberFormat(label ? label : closest.dataPoint.x, this.valueFormatString, this.chart._cultureInfo);
					}
				...
				if (this.parent._position === "bottom" || this.parent._position === "top") {
					...
					if (hasAllLabels) {
						...
						textBlock.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: closest.dataPoint.x }) : !isNullOrUndefined(this.options.label) ? this.label : dateFormat(label ? label : closest.dataPoint.x, this.valueFormatString, this.chart._cultureInfo);
					}
					else if (this.parent.valueType === "number") {
						textBlock.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: closest.dataPoint.x }) : !isNullOrUndefined(this.options.label) ? this.label : numberFormat(label ? label : closest.dataPoint.x, this.valueFormatString, this.chart._cultureInfo);
					}
					...
					if (this.parent.dataSeries[index].type === "rangeColumn" || this.parent.dataSeries[index].type === "rangeArea" || this.parent.dataSeries[index].type === "error" || this.parent.dataSeries[index].type === "rangeSplineArea"
						...
						textBlock.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: label ? label : closest.dataSeries.dataPointEOs[closest.index].cumulativeSum }) : !isNullOrUndefined(this.options.label) ? this.label : numberFormat(label ? label : closest.dataSeries.dataPointEOs[closest.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo);
...
CanvasJSChart.version = "v3.2.6 GA";
