...
import { SbMainDeskComponent } from './sb-main-desk.component';
...
import {Frame136_Clean} from "./typing-bar-reply/frame-136/frame-136.stories";
...
import {Frame136Component} from "./typing-bar-reply/frame-136/frame-136.component";
import {BubbleComponent} from "./chat/./bubble/bubble.component";
import {StatusLabelComponent} from "./call-bar/status-label/status-label.component";
  ...
  decorators: [
    moduleMetadata({
      declarations: [
        ...
        CallBarComponent,
        BubbleComponent, ButtonComponent, StatusLabelComponent, IconPage2MdComponent,
        IconLarge11MdComponent, IconSmall8MdComponent,

        ChatComponent,
        BubbleComponent, SystemMessengeComponent,
...
const Template: Story<SbMainDeskComponent> = (args: SbMainDeskComponent) => ({
  props: args,
});
