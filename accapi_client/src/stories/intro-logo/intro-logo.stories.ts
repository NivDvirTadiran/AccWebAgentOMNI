...
const meta: Meta<IntroLogoComponent> = {
  title: "Design System/IntroLogo",
  component: IntroLogoComponent,
...
export default meta;
type Story = StoryObj<IntroLogoComponent>;



export const IntroLogo: Story = {
  render: args => ({
    //setup() {return { args };},
    props: args
