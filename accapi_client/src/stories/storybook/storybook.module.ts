...
import {IconSmall16MdComponent} from "../icons/icon-small-16/icon-small16-md.component";
...
import {IconSmall6MdComponent} from "../icons/icon-small-6/icon-small6-md.component";
