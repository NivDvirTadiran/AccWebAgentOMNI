...
import { CardThickComponent } from "./card-thick.component";



const meta: Meta<CardThickComponent> = {
  title: "Design System/CardThick",
  component: CardThickComponent,
...
export default meta;
type Story = StoryObj<CardThickComponent>;
