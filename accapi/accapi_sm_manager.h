...
//
//////////////////////////////////////////////////////////////////////
#ifndef ACCAPI_SM_MANAGER
#define ACCAPI_SM_MANAGER
...
// forward declaration
class AccapiWorkThread_c;

class AccapiSmReply_c : public IsmServiceReply_c  
{
public:
  //ctor
  AccapiSmReply_c();
  AccapiWorkThread_c * m_SbcWorkThread;
...
public:
  ...
  AccapiSmManager_c(AccapiWorkThread_c *SWT);
  virtual ~AccapiSmManager_c();
  AccapiWorkThread_c * m_SbcWorkThread;
  AccapiSmReply_c m_AccapiSmMReply;
